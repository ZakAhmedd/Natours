...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiemFrMTM0MSIsImEiOiJjbTl4Nm40M3AwZmFhMmpzZzhiaXppaWlqIn0.wQKJ1s2P_7y5Ox881yNMAw';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/zak1341/cm9yivcoi00wq01s594eydayg',
    // style URL
    scrollZoom: false
    // center: [-118.113491, 34.111745], // starting position
    // zoom: 4,
  });
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " uploaded successfully!"));
          }
          _context.next = 11;
          break;
        case 8:
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } /* eslint-disable */
var stripePromise = (0, _stripeJs.loadStripe)('pk_test_51RlrsqD7ToI3X3ypvefYTLlln6i660RGc9DqmY6XucYrMy2bIpU2AQtLJclv9w9hOzF0umOzyZMdxTvbIIHP0kBn00iVATGTXY');
